...
class LogUniformTournamentGCDSampler(TournamentGCDSampler):
    ...
    def _sample_biased(self, num_samples: int) -> np.ndarray:
        ...
        log_k_bound = np.emath.logn(self.log_base, sqrt_ubound)
